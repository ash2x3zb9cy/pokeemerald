...
extern const u8 gText_NamingScreenKeyboard_numbers[];
extern const u8 gText_NamingScreenKeyboard_qwertyuiop[];
extern const u8 gText_NamingScreenKeyboard_asdfghjkl[];
extern const u8 gText_NamingScreenKeyboard_zxcvbnm[];
extern const u8 gText_NamingScreenKeyboard_NUMBERS[];
extern const u8 gText_NamingScreenKeyboard_QWERTYUIOP[];
extern const u8 gText_NamingScreenKeyboard_ASDFGHJKL[];
extern const u8 gText_NamingScreenKeyboard_ZXCVBNM[];
